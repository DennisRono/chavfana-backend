...
class Settings(BaseSettings):
    ...
    AUTH_URL: str = "https://np-auth.nullchemy.com/api/v1/auth/login"
    ...
    # SSH Settings
    SSH_KEY_PATH: str = "/app/ssh_keys"
    SSH_KNOWN_HOSTS_PATH: str = "/app/ssh_keys/known_hosts"
